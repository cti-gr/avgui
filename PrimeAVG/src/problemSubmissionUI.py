...
#
# Created: Mon Feb 24 13:42:19 2014
...
class Ui_problemDialog(object):
    def setupUi(self, problemDialog):
        ...
        self.btnSubmit.setGeometry(QtCore.QRect(110, 860, 141, 41))
        font = QtGui.QFont()
        font.setWeight(75)
        font.setBold(True)
        ...
        self.btnCancel.setGeometry(QtCore.QRect(270, 860, 141, 41))
        font = QtGui.QFont()
        font.setWeight(75)
        font.setBold(True)
        ...
        self.lblProbDesc.setGeometry(QtCore.QRect(20, 380, 461, 36))
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Preferred, QtGui.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(1)
        sizePolicy.setVerticalStretch(0)
        ...
        self.txtProbDesc.setGeometry(QtCore.QRect(20, 420, 461, 431))
        self.txtProbDesc.setObjectName("txtProbDesc")
        self.gridLayoutWidget_2 = QtGui.QWidget(problemDialog)
        self.gridLayoutWidget_2.setGeometry(QtCore.QRect(20, 280, 461, 91))
        ...
        self.txtPassword = QtGui.QLineEdit(self.gridLayoutWidget_2)
        self.txtPassword.setObjectName("txtPassword")
        self.gridLayout_2.addWidget(self.txtPassword, 2, 1, 1, 1)
        ...
        self.txtEmail = QtGui.QLineEdit(self.gridLayoutWidget_2)
    ...
    def retranslateUi(self, problemDialog):
        ...
        self.label.setText(QtGui.QApplication.translate("problemDialog", "password", None, QtGui.QApplication.UnicodeUTF8))
        self.label_2.setText(QtGui.QApplication.translate("problemDialog", "email", None, QtGui.QApplication.UnicodeUTF8))
